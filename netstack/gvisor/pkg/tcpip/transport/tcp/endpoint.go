...
import (
	...
	"github.com/atoonk/packetio/netstack/gvisor/pkg/atomicbitops"
	...
	"github.com/atoonk/packetio/netstack/gvisor/pkg/tcpip/ports"
...
func (e *Endpoint) UnlockUser() {
	...
	if e.segmentQueue.emptyLocked() && !e.inlineDeferred.Load() {
